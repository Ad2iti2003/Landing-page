...
<div className='flex flex-wrap justify-center p-4 gap-2 lg:gap-x-10'>
  <div className='bg-sky-500 my-2 p-4 text-center rounded-lg w-72 shadow-lg shadow-slate-600'>
...
Ready To Tackle The Challenge</p>
  ...
  <div className='bg-sky-500 my-2 p-4 w-72 text-center rounded-lg shadow-lg shadow-slate-600'>
